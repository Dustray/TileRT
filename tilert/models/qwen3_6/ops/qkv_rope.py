...
__all__ = ['qkv_rope', 'QKVRoPE', 'QKVRoPERefWeightsAlias', 'QKVRoPETilertWeightsAlias']

def qkv_rope(pe_cache: torch.Tensor, kv_cache: torch.Tensor, rope_freqs: torch.Tensor, cur_pos: torch.Tensor, profile_logs: torch.Tensor, model_arch: str, compute_kernel_type: str='general') -> None:
    """
...
class QKVRoPE(TileRTModule):
    """QKV RoPE module. Unified for qwen3_6, deepseek_v3_2, and glm_5."""
